...
print("")
# Fights(Fields.list[0], Teams.list[2], Teams.list[3])
# Fights(Fields.list[0], Teams.list[4], Teams.list[5])
# Fights(Fields.list[0], Teams.list[3], Teams.list[4])
# Fights(Fields.list[1], Teams.list[6], Teams.list[7])
# Fights(Fields.list[1], Teams.list[0], Teams.list[1])
